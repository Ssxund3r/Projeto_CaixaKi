...
@Repository
public class DaoLogin extends ImplementacaoCrud<Object> implements Serializable, RepositoryLogin {
	...
	public boolean autentico(String login, String senha) throws Exception {
		...
		SqlRowSet sqlRowSet = (SqlRowSet) super.getJdbcTemplate().queryForRowSet(sql, new Object[] { login, senha });
