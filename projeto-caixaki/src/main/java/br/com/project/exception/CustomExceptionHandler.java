...
public class CustomExceptionHandler extends ExceptionHandlerWrapper implements Serializable {
	...
	/**
	 * Sobreescreve o método handle que é responsável por manipular as exceções do
	 * JSF
	 */
	@Override
	public void handle() throws FacesException {
		...
		while (iterator.hasNext()) {
			...
			//Aqui trabalhamos com a exceção 
			try {
				...
				if(exception != null && exception.getMessage() != null
					...
					//PrimeFaces
					//Este alert é exibido apenas quando a pagina não for redirecionada 
					...
					navigationHandler.handleNavigation(facesContext, null, 
							"/erro/error.jsf?faces-redirect=true&expired=true");
				}
